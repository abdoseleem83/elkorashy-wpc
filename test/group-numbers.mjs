...
// واسم اليوم جنب كل تاريخ — بالعربي الفصيح (الاثنين/الثلاثاء/الأربعاء)
const أيام = (r.نص.match(/الأحد|الاثنين|الثلاثاء|الأربعاء|الخميس|الجمعة|السبت/g)||[]);
check('اسم اليوم ظاهر مع كل طلب', أيام.length>=5, أيام.length+' يوم: '+أيام.join(' · '));
check('مفيش أسماء عامية (التلات/الاتنين/الأربع)',
  !/التلات\b|الاتنين|الأربع(?!اء)/.test(r.نص), (r.نص.match(/التلات\b|الاتنين|الأربع(?!اء)/g)||[]).join(' · '));
// واليوم الصح لكل تاريخ فعلاً — ٨/٩/٢٠٢٦ ثلاثاء، ٢/٩ أربعاء، ٢٧/٨ خميس، ٧/٩ اثنين، ٥/٩ سبت
const أيام_متوقعة = ['الثلاثاء','الأربعاء','الخميس','الاثنين','السبت'];
check('اسم اليوم مطابق للتاريخ',
  أيام_متوقعة.every(y=>أيام.includes(y)), 'ظاهر: '+أيام.join(' · '));
