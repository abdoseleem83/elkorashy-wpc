...
const out = await pg.evaluate(() => {
  ...
  // الأرقام الهندية (العربية والفارسية) لازم تتقبل — الكيبورد العربي بيكتب بيها
  const okPhones = ['01012345678','01112345678','01212345678','01512345678','1012345678',
                    '٠١٠١٢٣٤٥٦٧٨','۰۱۰۱۲۳۴۵۶۷۸','٠١٠1234567٨'];
  const badPhones = ['0101234567','010123456789','02012345678','','abc',
                     '٠١٠١٢٣٤','٠٢٠١٢٣٤٥٦٧٨','0101234567a','+201012345678'];
